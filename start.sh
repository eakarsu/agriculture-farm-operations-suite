...
PORT="${PORT:-5650}"
DB_NAME="${PGDATABASE:-agriculture_farm_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Agriculture Farm Operations Suite"
echo "======================================="
echo
...
echo "Starting agriculture farm operations suite frontend on http://localhost:$PORT"
echo "Login: admin@agriculture-farm-operations.local / admin123"
