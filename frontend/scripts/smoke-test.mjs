const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:5650';
...
const adminCookie = await login('admin@agriculture-farm-operations.local', 'admin123');
const managerCookie = await login('manager@agriculture-farm-operations.local', 'manager123');
const analystCookie = await login('analyst@agriculture-farm-operations.local', 'analyst123');
