...
const entitySeeds = [
  ['records', 'Records Records', 'Records priority queue', 'Open', 'Records exception list', 'Operations Lead', '$0'],
  ['workspaces', 'Workspaces Records', 'Workspaces priority queue', 'Review', 'Workspaces exception list', 'Operations Lead', '$0'],
  ['requests', 'Requests Records', 'Requests priority queue', 'Action needed', 'Requests exception list', 'Operations Lead', '$0'],
  ['cases', 'Cases Records', 'Cases priority queue', 'Open', 'Cases exception list', 'Operations Lead', '$0'],
  ['schedules', 'Schedules Records', 'Schedules priority queue', 'Review', 'Schedules exception list', 'Operations Lead', '$0'],
  ...
  ['analytics', 'Analytics Records', 'Analytics priority queue', 'Open', 'Analytics exception list', 'Governance Lead', '$0'],
  ...
  ["yield-prediction","Yield Prediction Records","Yield Prediction operating queue","Open","Yield Prediction follow-up list","Yield Prediction Market Intel","$0"],
  ["crop-market-intel","Crop Market Intel Records","Crop Market Intel operating queue","Review","Crop Market Intel follow-up list","Yield Prediction Market Intel","$0"],
  ["harvest-risk-plan","Harvest Risk Plan Records","Harvest Risk Plan operating queue","Review","Harvest Risk Plan follow-up list","Yield Prediction Market Intel","$0"],
