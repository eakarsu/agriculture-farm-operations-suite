export const AUTH_COOKIE = 'agriculture_farm_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@agriculture-farm-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@agriculture-farm-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@agriculture-farm-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
