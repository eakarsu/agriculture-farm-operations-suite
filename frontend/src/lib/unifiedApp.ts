...
const features = [
  {
    ...
    summary: 'Records workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Users,
    summary: 'Workspaces workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ClipboardList,
    summary: 'Requests workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: CalendarCheck,
    summary: 'Cases workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Schedules workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Resources workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Exceptions workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Analytics workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Forecasts workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Agriculture Farm Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Workflow,
    summary: "Yield Prediction elevated from the Yield Prediction Market Intel source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Yield Prediction queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Yield Prediction", value: "24", note: 'Active' },
      { label: 'Review', value: "4", note: 'Needs attention' },
      { label: 'Due Soon', value: "3", note: 'Next 14 days' },
    ],
  },
  {
    slug: "crop-market-intel",
    title: "Crop Market Intel",
    href: "/crop-market-intel",
    category: "Yield Prediction Market Intel",
    icon: Workflow,
    summary: "Crop Market Intel elevated from the Yield Prediction Market Intel source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Crop Market Intel queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Crop Market Intel", value: "33", note: 'Active' },
      { label: 'Review', value: "5", note: 'Needs attention' },
      { label: 'Due Soon', value: "4", note: 'Next 14 days' },
    ],
  },
  {
    slug: "harvest-risk-plan",
    title: "Harvest Risk Plan",
    href: "/harvest-risk-plan",
    category: "Yield Prediction Market Intel",
    icon: Workflow,
    summary: "Harvest Risk Plan elevated from the Yield Prediction Market Intel source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Harvest Risk Plan queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Harvest Risk Plan", value: "42", note: 'Active' },
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Agriculture Farm Operations documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Agriculture Farm Operations alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Agriculture Farm Operations source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Agriculture Farm Operations users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Agriculture Farm Operations assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  ...
  { name: 'Yield Prediction Market Intel', features: ["Yield Prediction","Crop Market Intel","Harvest Risk Plan"] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIAgricultureFarmOperationsAssistant', 'AIAgricultureFarmOperationsOperations where applicable'],
