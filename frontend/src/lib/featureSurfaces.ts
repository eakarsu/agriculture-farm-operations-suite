...
const featureSeeds = [
  ['records', 'Records', 'Records operating queue', 'Operations Lead', 'Review and assign next action'],
  ['workspaces', 'Workspaces', 'Workspaces operating queue', 'Operations Lead', 'Review and assign next action'],
  ['requests', 'Requests', 'Requests operating queue', 'Operations Lead', 'Review and assign next action'],
  ['cases', 'Cases', 'Cases operating queue', 'Operations Lead', 'Review and assign next action'],
  ['schedules', 'Schedules', 'Schedules operating queue', 'Operations Lead', 'Review and assign next action'],
  ['resources', 'Resources', 'Resources operating queue', 'Operations Lead', 'Review and assign next action'],
  ['approvals', 'Approvals', 'Approvals operating queue', 'Operations Lead', 'Review and assign next action'],
  ['exceptions', 'Exceptions', 'Exceptions operating queue', 'Operations Lead', 'Review and assign next action'],
  ['compliance', 'Compliance', 'Compliance operating queue', 'Governance Lead', 'Review and assign next action'],
  ['analytics', 'Analytics', 'Analytics operating queue', 'Governance Lead', 'Review and assign next action'],
  ['forecasts', 'Forecasts', 'Forecasts operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ['reports', 'Reports', 'Reports operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ["yield-prediction","Yield Prediction","Yield Prediction review queue","Yield Prediction Market Intel","Review source context and assign owner"],
  ["crop-market-intel","Crop Market Intel","Crop Market Intel review queue","Yield Prediction Market Intel","Confirm next action and update evidence"],
  ["harvest-risk-plan","Harvest Risk Plan","Harvest Risk Plan review queue","Yield Prediction Market Intel","Confirm next action and update evidence"],
