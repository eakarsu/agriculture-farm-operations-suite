...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded agriculture farm operations suite demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="pill">Agriculture Farm Operations</div>
        <h1 style={{ marginBottom: 8 }}>Unified healthcare login</h1>
        <div className="muted">
          One login for agriculture farm operations features, documents, notifications, audit, approvals, and AI operations.
        </div>
